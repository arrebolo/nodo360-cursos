...
const recursos = [
  { icono: '📄', titulo: 'Guía Inflación', descripcion: 'Cómo protegerte de la inflación con ejemplos prácticos' },
  { icono: '📊', titulo: 'Historia de Crisis', descripcion: 'Cronología de crisis bancarias desde 1900' },
  { icono: '✅', titulo: 'Checklist Dinero', descripcion: 'Evalúa tu exposición a problemas del dinero tradicional' },
]
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {recursos.map((recurso, index) => (
            <div key={index} className="bg-gray-800/50 border border-gray-700 rounded-lg p-6 hover:border-orange-500/50 transition-all">
              ...
              <button className="text-orange-400 font-semibold text-sm hover:text-orange-300 transition-colors">
                Descargar PDF →
              </button>
            </div>
          ))}
